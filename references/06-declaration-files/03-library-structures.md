...
Then use the template `module-function.d.ts` if your module can be _called_ like a function:
...
Use the template `module-class.d.ts` if your module can be _constructed_ using `new`:
